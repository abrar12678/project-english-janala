...
const displayLevelWord = (words) => {
    ...
    <div class="bg-white rounded-xl shadow-sm text-center py-10 px-5 space-y-4">
        ...
        <div class="text-2xl font-medium bangla-font">"${word.meaning ? word.meaning : "অর্থ পাওয়া যায়নি"} / ${word.pronunciation ? word.pronunciation : "Pronounciation পাওয়া  যায়নি"}"</div> 
